...
* I don't see the Y button pressed down animation when i press the button, i do for A B and X
* The power light always seems to be on, it should only be on while the system is on
