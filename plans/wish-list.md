...
* Add better audio players, one better for spatial audio
    * look in to the GDExtenstions godot-steam-audio, https://github.com/stechyo/godot-steam-audio

* Webserver should use a pin for better security
    * it shows a pin in the option menu, that the website requires to be entered before it can download/upload view files
* Webserver should also allow the libretro folder to be viewable for download/upload/viewing
