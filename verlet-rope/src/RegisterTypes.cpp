...
void initialize(ModuleInitializationLevel p_level)
{
    ...
    ClassDB::register_class<Xenu::VerletRope>();
}
...
extern "C"
{
GDExtensionBool GDE_EXPORT verlet_rope_library_init(GDExtensionInterfaceGetProcAddress p_gde_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization)
{
