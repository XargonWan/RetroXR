...
##
##   godot --headless --path RetroXR --script res://Tools/gen_wii_sensor.gd
##
...
const OUT_PLUG := "res://Scenes/Objects/wii_sensor_plug.res"
const OUT_JACK := "res://Scenes/Objects/wii_sensor_jack.res"
