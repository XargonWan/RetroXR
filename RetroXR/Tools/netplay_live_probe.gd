...
##   host:   godot --path RetroXR --rendering-driver opengl3 res://Tools/netplay_live_probe.tscn -- --net-host
##   client: godot --path RetroXR --rendering-driver opengl3 res://Tools/netplay_live_probe.tscn -- --net-join=127.0.0.1
##
