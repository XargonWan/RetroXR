...
void initialize(ModuleInitializationLevel p_level)
{
    ...
    ClassDB::register_class<Xenu::RommArchiveExtractor>();
}
...
extern "C"
{
GDExtensionBool GDE_EXPORT archive_godot_library_init(
    GDExtensionInterfaceGetProcAddress p_gde_get_proc_address,
    const GDExtensionClassLibraryPtr p_library,
    GDExtensionInitialization* r_initialization)
{
    GDExtensionBinding::InitObject init_obj(
        p_gde_get_proc_address, p_library, r_initialization);
